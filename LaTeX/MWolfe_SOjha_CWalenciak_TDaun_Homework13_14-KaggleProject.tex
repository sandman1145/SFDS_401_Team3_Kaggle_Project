...
\begin{table}[H] % [h] forces the table to be output where it is defined in the code (it suppresses floating)
	...
	\caption{Results of Neighborhood Impact on Sales Price.} %1
	\label{tab:SMM}
\end{table}
\hrulefill
\begin{table}[H] % [h] forces the table to be output where it is defined in the code (it suppresses floating)
	...
	\caption{Results of Neighborhood Impact on Sales Price.} %2
	\label{tab:A1Results}
\end{table}
\hrulefill
\begin{table}[H] % [h] forces the table to be output where it is defined in the code (it suppresses floating)
	\centering % Centre the table
	\includegraphics[scale=.25]{../graphics/A2FWfeatures} %3 
...
\begin{table}[H] % [h] forces the table to be output where it is defined in the code (it suppresses floating)
	...
	\caption{Forward Selection Model 95\% Confidence Limits.} %4
	\label{tab:A2FWCI}
\end{table}
\hrulefill
\begin{table}[H] % [h] forces the table to be output where it is defined in the code (it suppresses floating)
	...
	\caption{Forward Selection Model Performance.} %5
	\label{tab:A2FWperf}
\end{table}
\hrulefill
\begin{table}[H] % [h] forces the table to be output where it is defined in the code (it suppresses floating)
	...
	\caption{Forward Selection Model Performance - Kaggle.} %6
...
\begin{table}[H] % [h] forces the table to be output where it is defined in the code (it suppresses floating)
	...
	\caption{Backward Selection Model 95\% Confidence Limits.} %7
	\label{tab:A2BWCI}
\end{table}
\hrulefill
\begin{table}[H] % [h] forces the table to be output where it is defined in the code (it suppresses floating)
	...
	\caption{Backward Selection Model Performance.} %8
	\label{tab:A2BWperf}
\end{table}
\hrulefill
\begin{table}[H] % [h] forces the table to be output where it is defined in the code (it suppresses floating)
	...
	\caption{Backward Selection Model Performance - Kaggle.} %9
...
\begin{table}[H] % [h] forces the table to be output where it is defined in the code (it suppresses floating)
	...
	\caption{Stepwise Selection Model Summary.} %10
...
\begin{table}[H] % [h] forces the table to be output where it is defined in the code (it suppresses floating)
	...
	\caption{Stepwise Selection Model 95\% Confidence Limits.} %11
	\label{tab:A2SWCI}
\end{table}
\hrulefill\begin{table}[H] % [h] forces the table to be output where it is defined in the code (it suppresses floating)
	\centering % Centre the table
	\includegraphics[scale=.3]{../graphics/A2SWresults}
	\caption{Stepwise Selection Model Performance.} %12
	\label{tab:A2SWperf}
\end{table}
\hrulefill
\begin{table}[H] % [h] forces the table to be output where it is defined in the code (it suppresses floating)
	...
	\caption{Stepwise Selection Model Performance - Kaggle.} %13
...
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	...
	\multicolumn{1}{|c|}{Original} & \multicolumn{1}{|c|}{After Removal of Outliers} \\
		...
		\hline
	\end{tabular}		
	\caption{Simple Linear Regression Models.} %1
	\label{fig:A1LR}
\end{figure}
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
...
\hline	
	\multicolumn{2}{|c|}{Original} &  \multicolumn{2}{|c|}{After Removal of Outliers} \\
		...
		\hline
	\end{tabular}		
	\caption{Influential Point Plots.} %4
	\label{fig:A1IP}
\end{figure}
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
...
\hline	
	\multicolumn{1}{|c|}{Original} &  \multicolumn{1}{|c|}{After Removal of Outliers} \\
		...
		\hline
	\end{tabular}		
	\caption{Scatterplot of Sale Prices vs Living Area by Neighborhood.} %5
	\label{fig:NBscat}
\end{figure}
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
	...
	\hline
	\end{tabular}	
	\caption{Linear Regression Model by Neighborhood.} %6
	\label{fig:NBLRM}
\end{figure}
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
	...
	\multicolumn{1}{|c}{} &  \multicolumn{1}{c|}{} \\
		...
		\hline
	\end{tabular}		
	\caption{Plots for Forward Selection Model.} %7
	\label{fig:A2FWAss}
\end{figure}
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
	...
	\hline
	\end{tabular}	
	\caption{Scatter Plot Forward Selection Model.} %8
	\label{fig:A2FWscatt}
\end{figure}
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
...
\hline	
	\multicolumn{1}{|c}{} &  \multicolumn{1}{c|}{} \\
		...
		\hline
	\end{tabular}		
	\caption{Normality Plots for Forward Selection Model.} %9
	\label{fig:A2FWQQ}
\end{figure}
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
...
\hline	
	\multicolumn{1}{|c}{} &  \multicolumn{1}{c|}{} \\
		...
		\hline
	\end{tabular}		
	\caption{Influential Point Plots for Forward Selection Model.} %10
	\label{fig:A2FWIP}
\end{figure}
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
	...
	\multicolumn{1}{|c}{} &  \multicolumn{1}{c|}{} \\
		...
		\hline
	\end{tabular}		
	\caption{Plots for Backward Selection Model.} %11
	\label{fig:A2BWAss}
\end{figure}
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
	...
	\hline
	\end{tabular}	
	\caption{Scatter Plot Backward Selection Model.} %12
	\label{fig:A2BWscatt}
\end{figure}
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
...
\hline	
	\multicolumn{1}{|c}{} &  \multicolumn{1}{c|}{} \\
		...
		\hline
	\end{tabular}		
	\caption{Normality Plots for Backward Selection Model.} %13
	\label{fig:A2BWQQ}
\end{figure}
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
...
\hline	
	\multicolumn{1}{|c}{} &  \multicolumn{1}{c|}{} \\
		...
		\hline
	\end{tabular}		
	\caption{Influential Point Plots for Backward Selection Model.} %14
	\label{fig:A2BWIP}
\end{figure}
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
	...
	\multicolumn{1}{|c}{} &  \multicolumn{1}{c|}{} \\
		...
		\hline
	\end{tabular}		
	\caption{Plots for Stepwise Selection Model.} %15
	\label{fig:A2SWAss}
\end{figure}
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
	...
	\hline
	\end{tabular}	
	\caption{Scatter Plot Stepwise Selection Model.} %16
	\label{fig:A2SWscatt}
\end{figure}
...
\hline	
	\multicolumn{1}{|c}{} &  \multicolumn{1}{c|}{} \\
		...
		\hline
	\end{tabular}		
	\caption{Normality Plots for Stepwise Selection Model.} %17
	\label{fig:A2SWQQ}
\end{figure}
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
...
\hline	
	\multicolumn{1}{|c}{} &  \multicolumn{1}{c|}{} \\
		...
		\hline
	\end{tabular}		
	\caption{Influential Point Plots for Stepwise Selection Model.} %18
	\label{fig:A2SWIP}
\end{figure}
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
	...
	\multicolumn{1}{|c}{} &  \multicolumn{1}{c|}{} \\
		...
		\hline
	\end{tabular}		
	\caption{Plots for Custom Selection Model.} %19
...
\begin{figure}[H] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	...
	\hline
	\end{tabular}	
	\caption{Scatter Plot Custom Model.} %20
...
\hline	
	\multicolumn{1}{|c}{} &  \multicolumn{1}{c|}{} \\
		...
		\hline
	\end{tabular}		
	\caption{Normality Plots for Custom Selection Model.} %21
...
\hline	
	\multicolumn{1}{|c}{} &  \multicolumn{1}{c|}{} \\
		...
		\hline
	\end{tabular}		
	\caption{Influential Point Plots for Custom Selection Model.} %22
...
\label{sec:Analysis1}
\lstinputlisting[
	caption=Analysis 1 SAS Code (Analysis1.sas)., % Caption above the listing
...
\lstinputlisting[
	caption=Forward Selection SAS Code (Forward.sas)., % Caption above the listing
...
\lstinputlisting[
	caption=Backward Selection SAS Code (Backward.sas)., % Caption above the listing
...
\lstinputlisting[
	caption=Stepwise Selection SAS Code (Stepwise.sas)., % Caption above the listing
...
\lstinputlisting[
	caption=Custom Model SAS Code (Carls\_Custom.sas)., % Caption above the listing
